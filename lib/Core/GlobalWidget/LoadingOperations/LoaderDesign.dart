...
import 'package:lcwassist/Core/GlobalWidget/LoadingOperations/DotType.dart';


class LoaderDesign extends StatefulWidget {
...
class _ColorLoader4State extends State<LoaderDesign>
        ...
        children: <Widget>[
          new Transform.translate(
            ...
            child: new Padding(
              ...
              child: Dot(
                radius: 10.0,
                color: Color.fromRGBO(0, 185, 242, 1.0),//widget.dotOneColor,
                type: widget.dotType,
                icon: widget.dotIcon,
              ),
            ),
          ...
          Transform.translate(
            ...
            child: new Padding(
              ...
              child: Dot(
                radius: 10.0,
                color: Color.fromRGBO(230, 26, 113, 1.0),//widget.dotTwoColor,
                type: widget.dotType,
                icon: widget.dotIcon,
              ),
            ),
          ...
          Transform.translate(
            ...
            child: new Padding(
              ...
              child: Dot(
                radius: 10.0,
                color: Color.fromRGBO(247, 147, 30, 1.0),//widget.dotThreeColor,
                type: widget.dotType,
                icon: widget.dotIcon,
              ),
            ),
...
Transform.translate(
            ...
            child: new Padding(
              ...
              child: Dot(
                radius: 10.0,
                color: Color.fromRGBO(190, 215, 48, 1.0),//Colors.yellow[700],//widget.dotThreeColor,
                type: widget.dotType,
                icon: widget.dotIcon,
              ),
            ),
