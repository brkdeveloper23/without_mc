...
class LoaderDesign2 extends StatefulWidget {

  final Color color1;
  final Color color2;
  final Color color3;

  //LoaderDesign2({this.color1 = Colors.blue, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});
LoaderDesign2({this.color1 = Colors.blue, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});
  @override
  _LoaderDesign2State createState() => _LoaderDesign2State();
}

class _LoaderDesign2State extends State<LoaderDesign2> with TickerProviderStateMixin {
...
Color color11 =Color.fromRGBO(232,25,50,1.0);
Color color22 =Color.fromRGBO(232,25,50,1.0);
Color color33 =Color.fromRGBO(232,25,50,1.0);
